...
# [Test ] Step: 10000, acc: 0.62450 参数会损失
def mobilenet(x,
    ...
    Args:
    - x:
    - output_channel: eg: 1*1
    - name:
    """
    with tf.variable_scope(name):
        input_channel = x.get_shape().as_list()[-1]
        channel_wise_x = tf.split(x, input_channel, axis=3)  # 在第四个维度上拆分
        output_channels = []
...
separable_2a = mobilenet(pooling1,
                                    32,
                                    name = 'separable_2a')
separable_2b = mobilenet(separable_2a,
                                    32,
                                    name = 'separable_2b')
...
separable_3a = mobilenet(pooling2,
                                    32,
                                    name = 'separable_3a')
separable_3b = mobilenet(separable_3a,
                                    32,
                                    name = 'separable_3b')
